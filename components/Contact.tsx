  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <textarea
          className="h-52 px-4 py-3 rounded-lg border border-gray-300 dark:bg-white dark:bg-opacity-80 dark:focus:bg-opacity-100 transition-all dark:outline-none"
          name="message"
